...
TokenHandler.prototype.getClient = function(request, response) {
  ...
  if (this.checkClientAuthentication(grantType) && !credentials.clientSecret) {
...
TokenHandler.prototype.getClientCredentials = function(request) {
  ...
  if (!this.checkClientAuthentication(grantType)) {
 ...
 */
TokenHandler.prototype.checkClientAuthentication = function(grantType) {
